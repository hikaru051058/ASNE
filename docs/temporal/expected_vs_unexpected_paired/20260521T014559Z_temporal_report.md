...
- Eval summary: `outputs/asne_evals/contrasts/expected_vs_unexpected_paired/20260521T013237Z_summary.json`
...
|---|---|---|---|---|---|---|---:|---:|
| eval_paired_expected_outcome_01 | expected_outcome | unexpected_outcome | unexpected_outcome | expected_outcome | expected_outcome | expected_outcome | 1 | 15.6490 |
| eval_paired_expected_outcome_02 | expected_outcome | expected_outcome | unexpected_outcome | unexpected_outcome | expected_outcome | unexpected_outcome | 1 | 13.8491 |
...
### eval_paired_expected_outcome_01

- Input: A person puts a notebook on a desk. A moment later, the notebook remains on the desk.
- Expected: expected_outcome
- Mean-response top category: unexpected_outcome
- Segment winners: ['unexpected_outcome', 'unexpected_outcome', 'expected_outcome', 'expected_outcome', 'expected_outcome']
- Late winner: expected_outcome
- Final segment winner: expected_outcome
- Majority segment winner: expected_outcome
